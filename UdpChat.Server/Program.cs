...
class CentralRetransmissionServer
{
    ...
    private UdpState authenticationServer { get; set; }
    ...
    private void RegisterUser(String name, String password, String ipAddress, int port)
    {
    ...
    private void StartAuthenticationServer()
    {
        ...
        this.authenticationServer = new UdpState(authSocket, authEndpoint);
    }
    ...
    private void Stop()
    {
        ...
        authenticationServer.socket.Close();
    ...
    private void HandleRegisterRequest(Request req, ref UdpState clientState)
    {
        ...
        var sentBytes = this.authenticationServer.socket.Send(regResBytes, regResBytes.Length, clientState.endpoint);
    ...
    public void Start()
    {
        ...
        this.authenticationServer.socket.BeginReceive(new AsyncCallback(AuthenticationHandler), this.authenticationServer);
        while (true)
        { }
    }
}
